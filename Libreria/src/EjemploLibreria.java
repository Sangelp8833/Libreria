                ...
                for (Usuario usr : admins) {
                    while (!salir) {
                        if (usr.getUsuario().equals(usuario) && usr.getContraseña().equals(contraseña)) {
                            System.out.println("Bienvenido " + usr.getUsuario() + " ¿Que deseas hacer?");
                            ...
                            switch (accesoAdmins) {
                                case 1:
                                    ...
                                    //System.out.println("El libro " + libros.get(libros.size()-1).toString() + " ha sido agregado.");
                                    break;
                                case 2:
